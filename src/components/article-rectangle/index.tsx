    ...
    return (
        <div className="cursor-pointer all-articles-article box-border overflow-hidden w-full">
            <div className="article font-primary group rounded-md h-full mix-blend-normal opacity-70 hover:bg-[#fafafa] hover:opacity-100 hover:ease-in-out duration-300  hover:scale-105">
                <a>
                    <div className="article-container p-7 flex flex-col gap-2">
                        <div className="mb-3 text-sm text-gray-400">
                            | 7 May 2023
                        </div>
                        <div className="article-title text-lg font-bold font-primary">
                        ...
                        <div className="article-description text-secondary text-sm">
                            ...
                            Find out why more businesses are turning to the
                            cloud.
                        </div>
                        <div className="article-link flex gap-5 mt-auto">
                            <div className="article-link-text text-green-400">
                                Read Article
                            </div>
