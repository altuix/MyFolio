                ...
                <a>
                    <div className="project-container p-7 h-72 flex flex-col">
                        ...
                        <div className="project-description text-secondary">
                            Lorem ipsum dolor sit amet. Et incidunt voluptatem
                            ex tempore repellendus qui dicta nemo sit deleniti
                            minima.
                        </div>
                        <div className="project-link flex gap-5 mt-auto">
                            ...
                            <div className="project-link-text group-hover:text-blue-400">
                                View Project
                            </div>
                        </div>
                    </div>
