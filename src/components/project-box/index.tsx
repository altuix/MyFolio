...
function ProjectBox() {
  return (
    ...
    <div className="cursor-pointer all-projects-project  box-border overflow-hidden w-1/3">
      <div className="project group rounded-md h-full mix-blend-normal opacity-80 hover:bg-[#fafafa] hover:opacity-100 hover:ease-in-out duration-300">
        <a >
