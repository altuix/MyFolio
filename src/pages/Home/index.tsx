        ...
        <div id='home' className='relative mb-8 flex flex-col-reverse lg:flex-row'>
          <div className='flex-1 pr-5'>
            ...
            <div className='mt-5 flex items-center justify-center gap-6 opacity-70 sm:justify-start'>
              <img className='h-8 w-auto' src={github} loading='lazy' />
              <img className='h-8 w-auto' src={linkedin} loading='lazy' />
              <img className='h-8 w-auto' src={deviantart} loading='lazy' />
            </div>
          </div>
          <div className='h-96 items-center justify-center self-center p-12 min-w-64'>

            <img
              className='min-w-[250px] bg-black h-full -rotate-12 rounded-xl shadow-inner  shadow-indigo-300 blur-sm grayscale transition duration-150 hover:rotate-0 hover:scale-110 hover:blur-0 hover:grayscale-0 hover:ease-out '
              src={myhead} loading='lazy'
            />
